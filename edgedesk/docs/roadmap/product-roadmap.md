...
| **7. Workbench** | ✅ F1 match checker, ✅ F2 alerts inbox, ✅ F3 background web push, ✅ F4 command palette | **Done** (F3 device test pending on Sam's Android) | A found match gets a verdict in <10s; no alert is ever lost; the phone buzzes with the app closed; any entity is two keystrokes away |
| **8. Momentum** | ✅ G1 targets & pace, 🔶 G2 demo mode done / onboarding wizard pending, ⬜ G3 season summary, ⬜ G4 access & keyboard | In progress | Home answers "am I on pace?" at a glance; a stranger reaches a working desk in <10 min; the year renders honestly |
