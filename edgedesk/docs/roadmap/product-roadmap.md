...
| D6  | **Architecture route lean: Route 1 (hosted multi-tenant).**                                                                                                                                                     | 2026-08-02 | Sam leans hosted for operational simplicity and easier updates/onboarding; supersedes the earlier Route 2 lean (§8). Formal decision due before F4 (accounts/billing) — nothing in F0–F3 is route-dependent.                                          |
...
| Multi-tenant route choice (hosted vs local-first sync)         | Leaning Route 1 (hosted) since 2026-08-02 (D6); formal decision before F4 |
