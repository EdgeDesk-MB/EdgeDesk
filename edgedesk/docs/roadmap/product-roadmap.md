...
| **3. Mobile** | ✅ §4 swipe deck, ⬜ quick-log (+B4 parser), ⬜ collapsed variants, ⬜ PWA install + local alerts | **In progress** — C1 done | Log a bet in ≤3 taps on a phone; Home usable one-handed |
