...
Last updated: 2026-07-22 (Phases 1–5 done; Tracks E–G added as Phases 6–8; business gate is now
Phase 9; §9 Future ideas parking lot added; Phase 13 — Acca Desk grows up — fully done same day:
styling pass, L1 probability meter, L2 history split, L3 boosted odds)
...
| **Price boost & bet builder checkers** | Manual-entry fair-price verdicts (extends F1 Match Checker): log a boost or builder price vs exchange fair odds → EV verdict + a "boost diary" of EV captured. The incumbents' finders are D2; the checkers are not | **PROMOTED → J2 (2026-07-16).** Separate Boosts page (Sam's call) |
...
| **Betslip prefill extension** | Betwatch-style browser extension: one click in EdgeDesk fills the exchange/bookie slip with selection + stake. Execution automation, not discovery | **PROMOTED → J9 (2026-07-16).** Last in the order deliberately (new surface) |
