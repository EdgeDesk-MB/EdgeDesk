    ...
    <header className="relative z-[45] shrink-0 border-b border-topbar-border bg-topbar text-topbar-foreground">
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 items-center justify-end gap-1 sm:gap-1.5">
          ...
          <button
            type="button"
            className="ml-3 flex h-9 shrink-0 items-center justify-center gap-1.5 rounded-md bg-[#111111] px-2.5 text-[11px] font-extrabold uppercase tracking-wide text-white shadow-sm transition-colors hover:bg-[#111111]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#111111]/40"
