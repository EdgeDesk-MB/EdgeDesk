  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "relative z-[80] flex w-fit min-w-0 max-w-[var(--overlay-max)] flex-col gap-1 text-pretty break-words text-left text-xs has-data-[slot=kbd]:flex-row has-data-[slot=kbd]:items-center",
