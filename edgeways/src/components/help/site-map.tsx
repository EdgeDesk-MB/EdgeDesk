...
const OBSERVATIONS: Array<{ title: string; detail: string }> = [
  ...
  },
  {
    ...
    detail:
      "The P&L Breakdown tab (?tab=pnl) and the settle queue (?queue=settle) are destinations in their own right. If they keep growing, Tracker → Bets / P&L is a natural sub-nav.",
  },
  {
