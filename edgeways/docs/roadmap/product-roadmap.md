...
| **16. Acca offer bridge** (promoted from §9, 2026-08-05)                                               | L4 — qualifier shape on offers + Place qualifying → global Acca New run (pro/entitled); Add bet fallback                                                                                                                                                                                                                                                                 | **Briefed**                                                     | An ACCA bet&get campaign routes the qualifier into Acca Desk with stake/bookie/offerId and requirements visible; singles stay on Add bet; bet builder captured for later                                                                                                                                                                                                                                                       |
