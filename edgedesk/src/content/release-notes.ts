...
export const RELEASE_NOTES: ReleaseNoteGroup[] = [
  {
    ...
    summary:
      "A target to pace the month against, and a safe parallel universe for showing EdgeDesk off.",
    entries: [
      {
        kind: "feature",
        area: "Home",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        area: "Alerts",
        href: "/alerts",
        text: "Alerts inbox: every alert EdgeDesk raises is kept, with an unread badge in the navigation. Notifications and toasts deliver in the moment; the inbox is the record - tap an alert to mark it read and jump to the right desk, or clear the lot with one tap.",
      },
      {
        kind: "improvement",
        area: "Alerts",
      ...
      },
      {
        ...
        area: "Settings",
        href: "/settings",
        text: "Background push: flip \"Push to this device\" in Settings → Alerts and sentinel alerts reach your phone with every EdgeDesk tab closed. Works anywhere your phone has signal, as long as the EdgeDesk server is running at home.",
      },
      {
        kind: "improvement",
        area: "Settings",
