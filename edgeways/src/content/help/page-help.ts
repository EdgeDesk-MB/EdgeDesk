...
export const PAGE_HELP: Record<PageHelpId, PageHelpContent> = {
  ...
  fixtures: {
    ...
    bullets: [
      ...
      "Football feed: ~one live-tracked match per day on the standard request budget.",
  ...
  settings: {
    ...
    bullets: [
      ...
      "Data & API shows connection status for the football, racing and exchange feeds.",
      "Refresh rates: racing cards cached ~15 min; exchange prices delayed ~1–3 min; football live ~60s.",
      "Email intake: forward promo emails to a dedicated mailbox folder and the desk drafts them as Planned campaigns for review. Never use a main account.",
