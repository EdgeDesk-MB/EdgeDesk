...
function Switch({
  ...
  size?: "sm" | "default"
  /**
   * On coloured Back/Lay panels: track uses black/white opacity so the control
   * stays legible on any bookie/exchange tint (never brand primary green).
   */
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          onPanel
            ...
            : "bg-white dark:data-checked:bg-primary-foreground dark:data-unchecked:bg-foreground"
        )}
      />
    </SwitchPrimitive.Root>
  )
