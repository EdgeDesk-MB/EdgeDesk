...
| **7. Workbench** | ✅ F1 match checker, ✅ F2 alerts inbox, ✅ F3 background web push (device test pending on Sam's Android), ⬜ F4 command palette | In progress | A found match gets a verdict in <10s; no alert is ever lost; the phone buzzes with the app closed; any entity is two keystrokes away |
